...
setup(
    ...
    ext_modules=cythonize([
        ...
        "smoke/model/collection/dt_decoders.pyx",
        ...
        "smoke/replay/handler/dem_savegame.pyx",
        ...
        "smoke/replay/handler/svc_classinfo.pyx",
        "smoke/replay/handler/svc_createstringtable.pyx",
        "smoke/replay/handler/svc_gameevent.pyx",
        "smoke/replay/handler/svc_gameeventlist.pyx",
        "smoke/replay/handler/svc_packetentities.pyx",
        "smoke/replay/handler/svc_sendtable.pyx",
        "smoke/replay/handler/svc_serverinfo.pyx",
        "smoke/replay/handler/svc_setview.pyx",
        "smoke/replay/handler/svc_sounds.pyx",
        "smoke/replay/handler/svc_tempentities.pyx",
        "smoke/replay/handler/svc_updatestringtable.pyx",
        "smoke/replay/handler/svc_usermessage.pyx",
        "smoke/replay/handler/svc_voicedata.pyx",
        "smoke/replay/handler/svc_voiceinit.pyx",
